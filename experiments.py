...
experiments_list = [
    ...
    # Experiment 22
    # Learned communication, with attention, reward shaping
    {
        "game_config": {
            "N": 10,
            "ends_when_no_wasps": False,
        ...
        "training_config": {
            "experiment_name": "comm_attn_shaping",
            "reward_shaping": True,
            "curriculum_learning": False,
        },
        "obs_config": {
    ...
    # Experiment 23
    # Learned communication, with self-attention, reward shaping
    {
        "game_config": {
            "N": 10,
            "ends_when_no_wasps": False,
        ...
        "training_config": {
            "experiment_name": "comm_self_attn_shaping",
            "reward_shaping": True,
            "curriculum_learning": False,
        },
        "obs_config": {
    ...
    # Experiment 24
    # Wasp: Learned communication, with attention, reward shaping
    {
        "game_config": {
            "N": 10,
            "ends_when_no_wasps": True,
        ...
        "training_config": {
            "experiment_name": "comm_wasp_attn_shaping",
            "reward_shaping": True,
            "curriculum_learning": False,
        },
        "obs_config": {
    ...
    # Experiment 25
    # Wasp: Learned communication, with self-attention, reward shaping
    {
        "game_config": {
            "N": 10,
            "ends_when_no_wasps": True,
        ...
        "training_config": {
            "experiment_name": "comm_wasp_self_attn_shaping",
            "reward_shaping": True,
            "curriculum_learning": False,
        },
        "obs_config": {
    ...
    # Experiment 27
    # With a bigger network: (512, 512, 512) vs (256, 256), wasp
    {
        "game_config": {
            "N": 10,
            "ends_when_no_wasps": True,
